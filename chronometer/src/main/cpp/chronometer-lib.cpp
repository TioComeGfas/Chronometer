...
JNIEXPORT void JNICALL Java_cl_tiocomegfas_chronometer_Chronometer_startClock(JNIEnv *env, jobject thiz, jobject cronometer_api) {
...
JNIEXPORT jdouble JNICALL Java_cl_tiocomegfas_chronometer_Chronometer_stopClock(JNIEnv *env, jobject thiz, jobject cronometer_api) {
    jclass cls = env->GetObjectClass(cronometer_api);
